...
public class Avion {
	...
	/*Devuelve la informacion del vuelo*/
	public String getInformacionAvion() {
		
		return "Avión con id: "+ getIdAvion() +" de la compañía: "+ getCompania() +", ha realizado \n"
				+ getNumVuelos()+ " vuelos, con un total de "+ getKmVolados() +" km y una media de "+ getMediaKms() +" km por vuelo.";
	}
